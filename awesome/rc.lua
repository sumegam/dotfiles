...
local theme_path = "~/.config/awesome/theme.lua"
...
globalkeys = gears.table.join(
    ...
    awful.key({ }, "#172", function () awful.util.spawn("playerctl play-pause") end,
              {description = "play/pause", group = "multimedia"}),
    awful.key({ }, "#174", function () awful.util.spawn("playerctl stop") end,
              {description = "stop playing", group = "multimedia"})
)
